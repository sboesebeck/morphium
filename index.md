...
```bash
curl -O https://repo1.maven.org/maven2/de/caluga/poppydb/6.3.4/poppydb-6.3.4-cli.jar
...
java -jar poppydb-6.3.4-cli.jar --port 27017 --no-config
```
...
```bash
java -jar poppydb-6.3.4-cli.jar --port 27017 --dump-dir ./data --dump-interval 300
```
...
```bash
java -jar poppydb-6.3.4-cli.jar -p 17017 --rs-name myrs \
...
| | 6.1.x | 6.2.x |
|---|---|---|
| Maven artifact | included in `morphium` | separate: `de.caluga:poppydb:6.3.4` |
...
This creates `poppydb/target/poppydb-6.3.4-cli.jar`.

**Running the Server**

```bash
# Start the server on the default port (17017)
java -jar poppydb/target/poppydb-6.3.4-cli.jar

# Start on a different port
java -jar poppydb/target/poppydb-6.3.4-cli.jar --port 8080

# Start with persistence (snapshots)
java -jar poppydb/target/poppydb-6.3.4-cli.jar --dump-dir ./data --dump-interval 300
```
...
```bash
java -jar poppydb/target/poppydb-6.3.4-cli.jar --rs-name my-rs --rs-seed host1:17017,host2:17018
```
