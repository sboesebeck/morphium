...
| Java | 21 |
| Quarkus | 3.32.3 |
| Morphium | 6.3.8-SNAPSHOT (built in lockstep as part of the [sboesebeck/morphium](https://github.com/sboesebeck/morphium) reactor) |
...
<dependency>
    ...
    <version>6.3.8-SNAPSHOT</version> <!-- MAINTAINERS: keep in sync with the table above and the root pom.xml -->
</dependency>
```
