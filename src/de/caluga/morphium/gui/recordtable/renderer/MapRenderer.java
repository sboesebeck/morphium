 ...
 * @author stephan
 */
public class MapRenderer extends RecordTableColumnRenderer implements TableCellEditor, TableCellRenderer {

    public MapRenderer(RecordTableState initialState) {
        super(initialState);
    }
