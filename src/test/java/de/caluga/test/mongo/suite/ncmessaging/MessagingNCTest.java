...
//            log.info("Got message!");
    ...
    public void messagingTest() throws Exception {
        ...
        try {
            ...
            messaging.addListenerForMessageNamed("test", (msg, m) -> {
    ...
    public void timeoutMessages() throws Exception {
        ...
        try {
            ...
            m1.setUseChangeStream(false).start();
            Thread.sleep(100);
            Msg m = new Msg().setMsgId(new MorphiumId()).setMsg("test").setName("name").setValue("a value").setTtl(-1000);
            m1.sendMessage(m);
            Thread.sleep(200);
            assert (cnt.get() == 0);
        } finally {
...
//
    ...
    public void exclusiveTest() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            r.addListenerForMessageNamed("test", (m, msg) -> {
