        ...
        try {
            for (WriteBufferEntry entry : localQueue) {
                if (morphium.getConfig().isAutoIndexAndCappedCreationOnWrite()
                        && !morphium.exists(
                                morphium.getConfig().getDatabase(), entry.getCollectionName())) {
                    createCappedColl(entry.getEntityType(), entry.getCollectionName());
                    //noinspection unchecked,unchecked
                    morphium.ensureIndicesFor(
                            entry.getEntityType(),
                        ...
                        WriteBuffer w =
                                morphium.getARHelper()
                                        .getAnnotationFromHierarchy(
                                                entry.getEntityType(), WriteBuffer.class);
                        bulkByCollectionName.put(
                                entry.getCollectionName(),
                                morphium.getDriver()
                                        .createBulkContext(
                                                morphium,
                                                ...
                                                entry.getCollectionName(),
                                                w.ordered(),
                                                morphium.getWriteConcernForClass(
                                                        entry.getEntityType())));
                    }
                ...
                switch (strategy) {
                    case WAIT:
                        ...
                        if (opLog.get(type) == null) {
                            ...
                            opLog.putIfAbsent(
                                    type, Collections.synchronizedList(new ArrayList<>()));
                        }
                    case JUST_WARN:
                    ...
                    if (isNew) {
                        ...
                        for (String f : morphium.getARHelper().getFields(o.getClass())) {
                            try {
                                ...
                                cmd.put(
                                        morphium.getARHelper().getMongoFieldName(o.getClass(), f),
                                        serialize);
                            } catch (IllegalAccessException e) {
                                e.printStackTrace();
                            }
        ...
        addToWriteQueue(
                ...
                ctx -> {
                    ...
                    morphium.firePreUpdateEvent(
                            ent.getClass(), MorphiumStorageListener.UpdateTypes.SET);
    ...
    public <T> void set(
        ...
        addToWriteQueue(
                ...
                ctx -> {
                    ...
                    // multiple, callback);
                    morphium.firePreUpdateEvent(
                            query.getType(), MorphiumStorageListener.UpdateTypes.SET);
    ...
    public <T> void inc(
        ...
        addToWriteQueue(
                ...
                ctx -> {
                    ...
                    // multiple, callback);
                    morphium.firePreUpdateEvent(
                            query.getType(), MorphiumStorageListener.UpdateTypes.INC);
                    UpdateBulkRequest wr = ctx.addUpdateBulkRequest();
                    wr.setQuery(Doc.of(query.toQueryObject()));
                    wr.setUpsert(upsert);
                    wr.setMultiple(multiple);
    ...
    public <T> void inc(
        ...
        addToWriteQueue(
                ...
                ctx -> {
                    ...
                    // multiple, callback);
                    morphium.firePreUpdateEvent(
                            obj.getClass(), MorphiumStorageListener.UpdateTypes.INC);
                    Query q =
    ...
    public <T> void pop(
        ...
        addToWriteQueue(
                ...
                ctx -> {
                    ...
                    // multiple, callback);
                    morphium.firePreUpdateEvent(
                            obj.getClass(), MorphiumStorageListener.UpdateTypes.POP);
                    Query q =
                            morphium.createQueryFor(obj.getClass())
                                    .f(morphium.getARHelper().getIdFieldName(obj))
                                    .eq(morphium.getARHelper().getId(obj));
                                ...
                                try {
                                    ...
                                    for (Class<?> clz : localBuffer) {
                                        ...
                                        if (lastRun.get(clz) != null
                                                && System.currentTimeMillis() - lastRun.get(clz)
                                                        > timeout) {
                                            // timeout reached....
                                            runIt(clz);
                                            continue;
        ...
        addToWriteQueue(
                ...
                ctx -> {
                    ...
                    switch (type) {
                        case PUSH:
                            morphium.firePreUpdateEvent(
                                    q.getType(), MorphiumStorageListener.UpdateTypes.PUSH);
                        ...
                        case PULL:
                            morphium.firePreUpdateEvent(
                                    q.getType(), MorphiumStorageListener.UpdateTypes.PULL);
                        ...
                        default:
                            throw new IllegalArgumentException(
                                    "Unsupported push type " + type.name());
                    }
                ...
                ctx -> {
                    ...
                    for (Object o : value) {
                        ...
                        switch (type) {
                            ...
                            default:
                                throw new IllegalArgumentException(
                                        "Unsupported operation " + type.name());
                        }
                        //                        ctx.addRequest(r);
                    }
    ...
    public <T> void unset(
        ...
        addToWriteQueue(
                ...
                ctx -> {
                    ...
                    // multiple, callback);
                    morphium.firePreUpdateEvent(
                            query.getType(), MorphiumStorageListener.UpdateTypes.UNSET);
                    UpdateBulkRequest wr = ctx.addUpdateBulkRequest();
                    wr.setQuery(Doc.of(query.toQueryObject()));
                    wr.setMultiple(multiple);
                    wr.setUpsert(false);
